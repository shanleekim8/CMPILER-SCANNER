...
outputStatement : OUTPUT LPAREN (IDENTIFIER | FLOAT_LITERAL | DECIMAL_LITERAL | STRING_LITERAL | CHAR_LITERAL)
                ((ADD) (IDENTIFIER | FLOAT_LITERAL | DECIMAL_LITERAL | STRING_LITERAL | CHAR_LITERAL))* RPAREN SEMI;
